  ...
  <el-dialog
    ...
    <div>
      <el-row>
        <el-col :span="12">
          <!-- <el-row :gutter="20"> -->
            <span :class="toleranceIndex == index?'toleranceIcon active':'toleranceIcon'" v-for="(item,index) in toleranceList" :key="index" 
              @click="getTolerance(item,index)">{{item.name}}%</span>
          <!-- </el-row> -->
        </el-col>
